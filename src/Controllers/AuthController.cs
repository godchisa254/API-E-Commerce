    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] UserRegristationDto registerDto)
        {
            try
            {
                ...
                var createUser = await _authRepository.CreateUserAsync(
                    appUser,
        ...
        public async Task<IActionResult> UpdatePassword([FromBody] ChangePasswordDto newPasswordDto)
        {
            try
            {
                ...
                var checkPassword = await _authRepository.checkPasswordbyId(
                    userId,
        ...
        [Authorize]
        public async Task<IActionResult> EditProfileUser(
            [FromBody] EditProfileUserDto editProfileUserDto
        )
        {
            try
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return Ok(new { Message = "Perfil editado correctamente", editUser });
                }
